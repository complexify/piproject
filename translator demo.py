    ...
    def evalaudio(self):
        while recording:
            ...
            try:
                ...
                self.audio_label["text"] = f"You said: '{inputedaudio}', The translation for {inputedaudio} ({constants.LANGUAGES[detection.lang]}), is: {translation.text} ({translang})"
                break
